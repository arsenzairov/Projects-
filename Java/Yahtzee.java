...
public class Yahtzee extends GraphicsProgram implements YahtzeeConstants {
	...
	public static void main(String[] args) {
		...
		private boolean checkSpecialCategory(int category){
			ArrayList <Integer> one = new <Integer> ArrayList();
			ArrayList <Integer> two = new <Integer> ArrayList();
			ArrayList <Integer> three = new <Integer> ArrayList();
			ArrayList <Integer> four = new <Integer> ArrayList();
			ArrayList <Integer> five = new <Integer> ArrayList();
			ArrayList <Integer> six = new <Integer> ArrayList();
			...
			if (category == THREE_OF_A_KIND){
				...
				if (one.size() == 1 && two.size() == 1 && three.size() == 1 && four.size() == 1)
					return true;
				if (two.size() == 1 && three.size() == 1 && four.size() == 1 && five.size() == 1)
					return true;
				if ( three.size() == 1 && four.size() == 1 && five.size() == 1 && six.size() == 1)
					return true;
			}
			else if(category == LARGE_STRAIGHT){
		...
		private void calculateWinner(){
			...
			display.printMessage("Congratulations " + playerNames[winner] + " you the winner with a total score of " + score);
		}
